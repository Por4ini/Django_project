...
SECRET_KEY = 'django-insecure-(&47sncp03=%5^4rkugc&_%ncq4lzhvrc-%g(@(u4gml61i$8&'
...
EMAIL_PORT = 465
# EMAIL_HOST_USER = DEFAULT_FROM_EMAIL = 'Задайте ВАШУ пошту'   Потрібна спеціальна smtp-пошта. Я користуюсья smtp.ukr.net
# EMAIL_HOST_PASSWORD = 'ВАШ пароль від пошти!'
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
...
# Сюди потрібно передати данні отримані на фейсбуці
